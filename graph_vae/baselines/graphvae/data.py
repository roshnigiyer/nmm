...
from baselines.graphvae.model import *
from baselines.graphvae.utils import *



# load clickstream dataset
def Graph_load_batch_clickstream(min_num_nodes = 1, max_num_nodes = 100, name = 'clickstream',node_attributes = False,
                                 graph_labels=False):
    '''
    load many graphs, e.g. clickstreams
    ...
    # add edges
    # G.add_weighted_edges_from(data_tuple)
